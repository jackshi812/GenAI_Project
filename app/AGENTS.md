...
The interface renders the `AssistantResult` it receives. It must not perform
retrieval, matching, reconciliation, or other business logic. Keep one
replaceable `load_result(transcript)` call site until graph integration.
